...
document.addEventListener('DOMContentLoaded', function() {
    ...
    CONFIG.setupDistance();
    
    // Get the calculator form element
    const calculatorForm = document.getElementById('calculator-form');
    if (!calculatorForm) {
        console.error('calculator-form não encontrado. Verifique index.html.');
        return;
    }
    ...
    function handleFormSubmit(event) {
        ...
        const submitButton = calculatorForm.querySelector('.calculator-form__submit');
        if (!submitButton) {
            console.error('Botão de submit não encontrado. Verifique se o elemento tem a classe .calculator-form__submit.');
            alert('Erro interno: botão de envio não encontrado.');
            return;
        }
        ...
        setTimeout(function() {
            try {
                ...
                const creditPrice = Calculator.estimatedCreditPrice(carbonCredits);
